...
# Solution Develop
# %%
# La idea del ejercicio es crear una lista con los nombres de las personas que tengan la segunda menor nota
# 
# Para efectos practicos, se crea una lista con los datos que se deben ingresar por teclado
some_list = [['Harry', 37.21], ['Berry', 37.21], ['Tina', 37.2], ['Akriti', 41], ['Harsh', 39]]
...
# 1.1.  Obtener la lista de las notas
# 1.2.  A esa lista quitarle los duplicados
# 1.3.  Ordenar la lista resultado del paso anterior
# 1.4.  Obtener el valor de la segunda posicion, la segunda menor nota
#
...
# 2.1.  Obtener la lista de los nombres de los estudiantes que su nota coincida con la segunda menor nota
# 2.2.  Ordenar el resultado de la lista anterior
# 
# 3.    Imprimir el resultado
[print(el) for el in lstResult]
# 3.1.  Recorrer la lista resultado del paso anterior
# 3.2.  Imprimir cada elemento de la lista
